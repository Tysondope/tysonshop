            ...
            <div class="row row-eq-height">
                ...
                <div class="col-md-6 padding0">
                    <div class="form_area bg-color-light1">
                        <form class="form form-style4 needs-validation" id="login" method="post" action="logincheck.php"  novalidate>
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-primary mb10" type="submit" name="Login" value="Login" onclick="return valid();">LOGIN</button>
                            </div>
                        </form>
                        <p class="text-center mb20">Or <a href="register.php" class="text-colorPrimary">Create a new account</a></p>
